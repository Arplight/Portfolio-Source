import Builderz from "../assets/Images/Work/Builderz.png";
import Tale from "../assets/Images/Work/Tale.png";
import Xbeat from "../assets/Images/Work/X_Beat.png";
...
export const projects = [
  ...
  {
    project_name: "Aroma panel",
    project_description:
      "Created an eCommerce dashboard with CRUD operations using RESTful APIs and integrated it with a Laravel backend for a smooth, dynamic, and responsive user experience.",
    project_skills:
      "React,\u00A0 Redux \u00A0, SCSS,\u00A0 React bootstrap,\u00A0 PWA, \u00A0 RESTful API's",
    project_image: Aroma,
    project_demo:
      "https://drive.google.com/drive/folders/12z-_0LCwvZtu7_hC60EnmMDHfzaQ-onB?usp=drive_link",
    project_code:
      "https://drive.google.com/drive/folders/12z-_0LCwvZtu7_hC60EnmMDHfzaQ-onB?usp=drive_link",
  ...
  {
    project_name: "Builderz",
    project_description:
      "Crafted an engaging Front-End project tailored for a construction company, presenting their services and projects with a user-friendly design.",
    project_skills:
